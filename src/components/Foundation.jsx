    ...
    >
      ...
      <div className="mx-auto max-w-page container-px grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-[32px] border border-white/10 shadow-glow-lg">
              <motion.img
                ...
                alt="The Syntera Tech Foundation in action"
                loading="lazy"
        ...
        <RevealGroup staggerChildren={0.16} className="lg:col-span-6">
          ...
          >
            At Syntera Tech, our mission is clear: we are dedicated to changing lives every single day.
