...
export default function IAMMaturityCheckPage() {
  ...
  useEffect(() => {
    document.title = 'IAM Security Challenge | Test Your Identity Security — Syntera Tech';
    window.scrollTo(0, 0);
              ...
              >
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                  ...
                  <p className="text-xs text-slate-500 font-medium mb-4">
                    Book a free 30-minute credentials audit and architect session with an Syntera Tech IAM Architect to review these gaps.
                  </p>
