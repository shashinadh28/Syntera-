...
export default function AIReadinessPage() {
  ...
  useEffect(() => {
    document.title = 'AI Readiness Assessment | Free Enterprise AI Score — Syntera Consulting';
    window.scrollTo(0, 0);
              ...
              >
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                  ...
                  <p className="text-xs text-slate-500 font-medium mb-4">
                    Book a free, 30-minute workshop with an Syntera Consulting AI Delivery Architect to detail these results.
                  </p>
